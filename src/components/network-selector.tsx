    ...
    return (
        <Dropdown>
                <Dropdown.Button bordered color="primary" >
                    <Image 
                        width={networks.find(n => n.name === selected)!.width ?? 22} 
                ...
                >
                    {networks.filter(n=> !n.disabled).map(network => 
                        <Dropdown.Item 
                            key={network.name} 
                            icon={<Image width={network.width ?? 22} src={network.img}></Image>}>
                            {network.name}
                        </Dropdown.Item>
